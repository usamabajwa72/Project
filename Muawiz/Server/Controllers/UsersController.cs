...
namespace Mudasser.Server.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class UsersController : ControllerBase
    {
        private readonly MudasserServerContext _context;

        public UsersController(MudasserServerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Users>> PostUsers(Users users)
        {
          if (_context.Users == null)
          {
              return Problem("Entity set 'MudasserServerContext.Users'  is null.");
          }
